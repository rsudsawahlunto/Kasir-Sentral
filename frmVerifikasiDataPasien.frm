...
Begin VB.Form frmVerifikasiData 
   ...
   EndProperty
   Icon            =   "frmVerifikasiDataPasien.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmVerifikasiDataPasien.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image2 
      Height          =   945
      Left            =   12960
      Picture         =   "frmVerifikasiDataPasien.frx":368B
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmVerifikasiDataPasien.frx":4B79
      Stretch         =   -1  'True
      Top             =   0
      Width           =   13095
   End
