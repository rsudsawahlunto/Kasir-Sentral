...
Public Function sp_AddRekapKomponenBiayaPelayananOAClaim(fNoBKM, fNoBKMClaimSebelumnya, fNoStruk, fJmlBayarOA, fNoPosting) As Boolean
    On Error GoTo hell_
...
Public Function sp_AddRekapKomponenBiayaPelayananApotikClaim(fNoBKM, fNoBKMClaimSebelumnya, fNoStruk, fJmlBayarApotik, fNoPosting) As Boolean
    On Error GoTo hell_
...
Public Function sp_AddRekapKomponenBiayaPelayananTMClaimNew(fNoBKM, fNoBKMClaimSebelumnya, fNoStruk, fJmlBayarTM, fJmlPembebasan, fNoPosting) As Boolean
    On Error GoTo hell_
    ...
    With dbcmd
        ...
        .Parameters.Append .CreateParameter("NoStruk", adChar, adParamInput, 10, fNoStruk)
        .Parameters.Append .CreateParameter("JmlBayar", adCurrency, adParamInput, , fJmlBayarTM)
        .Parameters.Append .CreateParameter("JmlPembebasan", adCurrency, adParamInput, , fJmlPembebasan)
        .Parameters.Append .CreateParameter("NoPosting", adChar, adParamInput, 10, fNoPosting)
...
Public Function sp_AddRekapKomponenBiayaPelayananOAClaimNew(fNoBKM, fNoBKMClaimSebelumnya, fNoStruk, fJmlBayarOA, fJmlPembebasan, fNoPosting) As Boolean
    On Error GoTo hell_
...
Public Function sp_AddRekapKomponenBiayaPelayananApotikClaimNew(fNoBKM, fNoBKMClaimSebelumnya, fNoStruk, fJmlBayarApotik, fJmlPembebasan, fNoPosting) As Boolean
    On Error GoTo hell_
...
Public Function sp_AddRekapKomponenBiayaPelayananTM(fNoBKM, fNoStruk, fJmlHrsDibayarTM, fJmlBayarTM, fJmlPembebasanTM, fSisaTagihanTM, fJmlDiscountTM, fNoPendaftaran, fNoPosting) As Boolean
    ...
    With dbcmd
        ...
        .Parameters.Append .CreateParameter("NoBKM", adChar, adParamInput, 10, fNoBKM)
        .Parameters.Append .CreateParameter("NoStruk", adChar, adParamInput, 10, fNoStruk)
        .Parameters.Append .CreateParameter("TotalBiayaHrsDibayar", adCurrency, adParamInput, , fJmlHrsDibayarTM)
        .Parameters.Append .CreateParameter("JmlBayar", adCurrency, adParamInput, , fJmlBayarTM) 'MASIH BELUM FRESH ###
        .Parameters.Append .CreateParameter("JmlPembebasan", adCurrency, adParamInput, , fJmlPembebasanTM)
        .Parameters.Append .CreateParameter("SisaTagihan", adCurrency, adParamInput, , fSisaTagihanTM)
...
Public Function sp_AddRekapKomponenBPRemunerasiTMDokterDelegasi(fNoPendaftaran, fNoBKM, fNoStruk) As Boolean
    ...
    With dbcmd
        ...
        Else
            Call Add_HistoryLoginActivity("Add_RekapKomponenBPRemunerasiTMNewDokterDelegasi")
        End If
        Call deleteADOCommandParameters(dbcmd)
        Set dbcmd = Nothing
    End With
...
Public Function sp_AddRekapKomponenBPRemunerasiTMNewDokterOperator2(fNoPendaftaran, fNoBKM, fNoStruk) As Boolean
    ...
    With dbcmd
        ...
        Else
            Call Add_HistoryLoginActivity("Add_RekapKomponenBPRemunerasiTMNewDokterOperator2")
        End If
        Call deleteADOCommandParameters(dbcmd)
        Set dbcmd = Nothing
    End With
...
Public Function sp_AddRekapKomponenBiayaPelayananOA(fNoBKM, fNoStruk, fJmlHrsDibayarOA, fJmlBayarOA, fJmlPembebasanOA, fSisaTagihanOA, fJmlDiscountOA, fNoPendaftaran, fNoPosting) As Boolean
    ...
    With dbcmd
        ...
        .Parameters.Append .CreateParameter("NoBKM", adChar, adParamInput, 10, fNoBKM)
        .Parameters.Append .CreateParameter("NoStruk", adChar, adParamInput, 10, fNoStruk)
        .Parameters.Append .CreateParameter("TotalBiayaHrsDibayar", adCurrency, adParamInput, , fJmlHrsDibayarOA)
        .Parameters.Append .CreateParameter("JmlBayar", adCurrency, adParamInput, , fJmlBayarOA)
        .Parameters.Append .CreateParameter("JmlPembebasan", adCurrency, adParamInput, , fJmlPembebasanOA)
        .Parameters.Append .CreateParameter("SisaTagihan", adCurrency, adParamInput, , fSisaTagihanOA)
...
Public Function f_AddPembatalanStrukPelayananKasir(fNoBKM As String, fNoStruk As String, fPembayaranKe As Integer, fKdRuangan As String, fIdUser As String)
    ...
    If fPembayaranKe = 1 And fMaxPembayaranKe = 1 Then 'pembayaran pertama
        Set fRS = Nothing
        ...
        Set fRS = Nothing
        fQuery = "Delete ConvertStrukPelayananToPasienPulang WHERE NoStruk='" & fNoStruk & "' "
        Call msubRecFO(fRS, fQuery)
    ...
    Set fRS = Nothing
    fQuery = "select NoBKM from PostingDataKasirPenerimaan where NoBKM='" & fNoBKM & "' AND JenisTransaksi ='TM'"
    Call msubRecFO(fRS, fQuery)
    If fRS.EOF = False Then
        ...
        Call Add_HistoryLoginActivity("Delete_RekapKomponenBPRemunerasiTMNew+Delete_RekapKomponenBiayaPelayananTMNew")
    End If
    Set fRS = Nothing
    fQuery = "select NoBKM from PostingDataKasirPenerimaan where NoBKM='" & fNoBKM & "' AND JenisTransaksi ='OA'"
    Call msubRecFO(fRS, fQuery)
    If fRS.EOF = False Then
...
Public Function f_AddStrukPelayananPasienDetail(fNoBKM As String, fNoStruk As String, fNoPendaftaran As String, fNoCM As String, fJmlBayar As Currency, fJmlDiscount As Currency, fSisaTagihan As Currency, fStatusBayar As String, fTotalBiayaOA As Currency, fJmlBayarOA As Currency, fJmlHutangPenjaminOA As Currency, fJmlTanggunganRSOA As Currency, fJmlPembebasanOA As Currency, fJmlHrsDibayarOA As Currency, fJmlDiscountOA As Currency, fSisaTagihanOA As Currency, fTotalBiayaTM As Currency, fJmlBayarTM As Currency, fJmlHutangPenjaminTM As Currency, fJmlTanggunganRSTM As Currency, fJmlPembebasanTM As Currency, fJmlHrsDibayarTM As Currency, fJmlDiscountTM As Currency, fSisaTagihanTM As Currency, fNoPosting As String)
    ...
    Dim fQuery2 As String
    Dim fQuery3 As String
    Dim Pelunasan As Currency
    Dim HutangPenjamin As Currency
    Dim fRSX As New ADODB.recordset

    Set fRSX = Nothing
    fQuery = "select JmlHarusDibayar,JmlHutangPenjamin from strukPelayananPasien where NoStruk = '" & fNoStruk & "'"
    Call msubRecFO(fRSX, fQuery)
    If IsNull(fRSX("JmlHarusDibayar").Value) = True Then Pelunasan = 0 Else Pelunasan = fRSX("JmlHarusDibayar").Value
    If IsNull(fRSX("JmlHutangPenjamin").Value) = True Then HutangPenjamin = 0 Else HutangPenjamin = fRSX("JmlHutangPenjamin").Value

    Set fRSX = Nothing
    fQuery = "select sum(b.JmlBayar) as Pelunasan from PembayaranTagihanPasien a inner join StrukBuktiKasMasuk b on a.NoBKM = b.NoBKM Left Outer join ReturStrukPembayaranPasien c on a.NoBKM = c.NoBKM where a.NoStruk = '" & fNoStruk & "' and c.NoBKM is Null"
    Call msubRecFO(fRSX, fQuery)
    If IsNull(fRSX("Pelunasan").Value) = False Then Pelunasan = Pelunasan - fRSX("Pelunasan").Value
    ...
    If UCase(fStatusPiutang) = "TM" Then
        ...
        Call Add_HistoryLoginActivity("Add_PostingDataOtomatis+Add_RekapKomponenBiayaPelayananTMNew+Add_RekapKomponenBPRemunerasiTMNew+Add_DaftarPiutangDokter")
    End If
    If UCase(fStatusPiutang) = "OA" Then
        Set fRS = Nothing
        fQuery = "insert into TotalBiayaPelayananOA values('" & fNoStruk & "'," & msubKonversiKomaTitik(CStr(fTotalBiayaOA)) & "," & msubKonversiKomaTitik(CStr(fJmlHutangPenjaminOA)) & "," & msubKonversiKomaTitik(CStr(fJmlTanggunganRSOA)) & "," & msubKonversiKomaTitik(CStr(fJmlPembebasanOA)) & "," & msubKonversiKomaTitik(CStr(fJmlHrsDibayarOA)) & "," & msubKonversiKomaTitik(CStr(fJmlDiscountOA)) & "," & msubKonversiKomaTitik(CStr(fJmlBayarOA)) & "," & msubKonversiKomaTitik(CStr(fSisaTagihanOA)) & "," & msubKonversiKomaTitik(CStr(fJmlHutangPenjaminOA)) & ")"
        Call msubRecFO(fRS, fQuery)
        Set fRS = Nothing
        fQuery = "insert into TotalBiayaPelayananOAHistory values('" & fNoStruk & "'," & msubKonversiKomaTitik(CStr(fTotalBiayaOA)) & "," & msubKonversiKomaTitik(CStr(fJmlHutangPenjaminOA)) & "," & msubKonversiKomaTitik(CStr(fJmlTanggunganRSOA)) & "," & msubKonversiKomaTitik(CStr(fJmlPembebasanOA)) & "," & msubKonversiKomaTitik(CStr(fJmlHrsDibayarOA)) & "," & msubKonversiKomaTitik(CStr(fJmlDiscountOA)) & "," & msubKonversiKomaTitik(CStr(fJmlBayarOA)) & "," & msubKonversiKomaTitik(CStr(fSisaTagihanOA)) & ")"
        Call msubRecFO(fRS, fQuery)
        Set fRS = Nothing
        fQuery = "insert into PembayaranTagihanPasien values('" & fNoBKM & "','" & fNoStruk & "',0," & msubKonversiKomaTitik(CStr(fJmlBayarOA)) & "," & msubKonversiKomaTitik(CStr(fJmlPembebasanOA)) & "," & msubKonversiKomaTitik(CStr(fSisaTagihanOA)) & ",1,'OA'," & msubKonversiKomaTitik(CStr(HutangPenjamin)) & " )"
        Call msubRecFO(fRS, fQuery)
        ...
        Call Add_HistoryLoginActivity("Add_PostingDataOtomatis+Add_RekapKomponenBiayaPelayananOANew+Add_RekapKomponenBPRemunerasiOANew")
    End If
    If UCase(fStatusPiutang) = "SA" Then
        Set fRS = Nothing
        fQuery = "insert into TotalBiayaPelayananOA values('" & fNoStruk & "'," & msubKonversiKomaTitik(CStr(fTotalBiayaOA)) & "," & msubKonversiKomaTitik(CStr(fJmlHutangPenjaminOA)) & "," & msubKonversiKomaTitik(CStr(fJmlTanggunganRSOA)) & "," & msubKonversiKomaTitik(CStr(fJmlPembebasanOA)) & "," & msubKonversiKomaTitik(CStr(fJmlHrsDibayarOA)) & "," & msubKonversiKomaTitik(CStr(fJmlDiscountOA)) & "," & msubKonversiKomaTitik(CStr(fJmlBayarOA)) & "," & msubKonversiKomaTitik(CStr(fSisaTagihanOA)) & "," & msubKonversiKomaTitik(CStr(fJmlHutangPenjaminOA)) & ")"
        ...
        Call msubRecFO(fRS, fQuery)
        Set fRS = Nothing
        fQuery = "insert into PembayaranTagihanPasien values('" & fNoBKM & "','" & fNoStruk & "',0," & msubKonversiKomaTitik(CStr(fJmlBayar)) & "," & msubKonversiKomaTitik(CStr(fJmlPembebasanTM)) & "+" & msubKonversiKomaTitik(CStr(fJmlPembebasanOA)) & "," & msubKonversiKomaTitik(CStr(fSisaTagihan)) & ",1,'SA'," & msubKonversiKomaTitik(CStr(HutangPenjamin)) & ")"
        Call msubRecFO(fRS, fQuery) 'OK
        If sp_AddRekapKomponenBiayaPelayananTM(fNoBKM, fNoStruk, fJmlHrsDibayarTM, fJmlBayarTM, fJmlPembebasanTM, fSisaTagihanTM, fJmlDiscountTM, mstrNoPen, fNoPosting) = False Then Exit Function
        If sp_AddRekapKomponenBiayaPelayananOA(fNoBKM, fNoStruk, fJmlHrsDibayarOA, fJmlBayarOA, fJmlPembebasanOA, fSisaTagihanOA, fJmlDiscountOA, mstrNoPen, fNoPosting) = False Then Exit Function
        If sp_AddRekapKomponenBPRemunerasiTM(mstrNoPen, fNoBKM, fNoStruk, fNoPosting) = False Then Exit Function
        If sp_AddRekapKomponenBPRemunerasiOA(mstrNoPen, fNoBKM, fNoStruk, fNoPosting) = False Then Exit Function
        ...
        Call Add_HistoryLoginActivity("Add_PostingDataOtomatis+Add_RekapKomponenBiayaPelayananTMNew+Add_RekapKomponenBiayaPelayananOANew+Add_RekapKomponenBPRemunerasiTMNew+Add_RekapKomponenBPRemunerasiOANew+Add_DaftarPiutangDokter")
    End If
    ...
    If Len(Trim(fKdRuanganAkhir)) <> "" And Len(Trim(fTglKeluar)) <> "" And Len(Trim(fTglMasuk)) <> "" Then
        ...
        If fRS2.Fields(0) = "02" Or fRS2.Fields(0) = "11" Or fRS2.Fields(0) = "12" Or fRS2.Fields(0) = "06" Then
            ...
            Set fRS2 = Nothing
            fQuery2 = "update StrukPelayananPasien set KdRuanganTerakhir = '" & strKdRuanganBayar & "' where NoStruk ='" & fNoStruk & "'"
            Call msubRecFO(fRS2, fQuery2)
        End If
    End If
End Function
...
Public Function f_AddStrukPelayananPasienDetailStatusBayarNol(fNoBKM As String, fNoStruk As String, fNoPendaftaran As String, fNoCM As String, fJmlBayar As Currency, fJmlDiscount As Currency, fSisaTagihan As Currency, fStatusBayar As String, fTotalBiayaOA As Currency, fJmlBayarOA As Currency, fJmlHutangPenjaminOA As Currency, fJmlTanggunganRSOA As Currency, fJmlPembebasanOA As Currency, fJmlHrsDibayarOA As Currency, fJmlDiscountOA As Currency, fSisaTagihanOA As Currency, fTotalBiayaTM As Currency, fJmlBayarTM As Currency, fJmlHutangPenjaminTM As Currency, fJmlTanggunganRSTM As Currency, fJmlPembebasanTM As Currency, fJmlHrsDibayarTM As Currency, fJmlDiscountTM As Currency, fSisaTagihanTM As Currency, fNoPosting As String)
    ...
    If UCase(fStatusPiutang) = "OA" Then
        ...
        Call msubRecFO(fRS, fQuery)
        Set fRS = Nothing
        fQuery = "insert into PembayaranTagihanPasien values('" & fNoBKM & "','" & fNoStruk & "',0," & msubKonversiKomaTitik(CStr(fJmlBayarOA)) & "," & msubKonversiKomaTitik(CStr(fJmlPembebasanOA)) & "+" & msubKonversiKomaTitik(CStr(fJmlDiscountOA)) & "," & msubKonversiKomaTitik(CStr(fSisaTagihanOA)) & ",1,'OA'," & msubKonversiKomaTitik(CStr(HutangPenjamin)) & ")"
        Call msubRecFO(fRS, fQuery)
        If sp_AddRekapKomponenBiayaPelayananOA(fNoBKM, fNoStruk, fJmlHrsDibayarOA, fJmlBayarOA, fJmlPembebasanOA, fSisaTagihanOA, fJmlDiscountOA, mstrNoPen, fNoPosting) = False Then Exit Function
        If sp_AddRekapKomponenBPRemunerasiOA(mstrNoPen, fNoBKM, fNoStruk, fNoPosting) = False Then Exit Function
        Call Add_HistoryLoginActivity("Add_PostingDataOtomatis+Add_RekapKomponenBiayaPelayananOANew+Add_RekapKomponenBPRemunerasiOANew")
    ...
    If UCase(fStatusPiutang) = "SA" Then
        ...
        Call msubRecFO(fRS, fQuery)
        Set fRS = Nothing
        fQuery = "insert into PembayaranTagihanPasien values('" & fNoBKM & "','" & fNoStruk & "',0," & msubKonversiKomaTitik(CStr(fJmlBayar)) & "," & msubKonversiKomaTitik(CStr(fJmlPembebasan)) & "+" & msubKonversiKomaTitik(CStr(fJmlDiscount)) & "," & msubKonversiKomaTitik(CStr(fSisaTagihan)) & ",1,'SA'," & msubKonversiKomaTitik(CStr(HutangPenjamin)) & ")"
        Call msubRecFO(fRS, fQuery)
        If sp_AddRekapKomponenBiayaPelayananTM(fNoBKM, fNoStruk, fJmlHrsDibayarTM, fJmlBayarTM, fJmlPembebasanTM, fSisaTagihanTM, fJmlDiscountTM, mstrNoPen, fNoPosting) = False Then Exit Function
        If sp_AddRekapKomponenBiayaPelayananOA(fNoBKM, fNoStruk, fJmlHrsDibayarOA, fJmlBayarOA, fJmlPembebasanOA, fSisaTagihanOA, fJmlDiscountOA, mstrNoPen, fNoPosting) = False Then Exit Function
        If sp_AddRekapKomponenBPRemunerasiTM(mstrNoPen, fNoBKM, fNoStruk, fNoPosting) = False Then Exit Function
...
Public Function f_AddPembayaranTagihanHutangPenjaminClaim(fPendaftaran As String, fNoBKM As String, fNoBKMSebelumnya As String, fNoStruk As String, fJmlBayar As Currency, fJmlPembebasan As Currency, fSisaHutangPenjamin As Currency, fStatusPiutang As String, fNoPosting As String)
    ...
    Dim fcurSisaHutPenjamin As Currency

    Dim fSisaHutangPenjaminTMNew As Currency
    Dim fSisaHutangPenjaminOANew As Currency
    ...
    If fTempPembayaranKe = 0 Then
        ...
        fQuery2 = "insert into PembayaranClaimPenjaminPasien values('" & fNoBKM & "','" & fNoStruk & "',0," & msubKonversiKomaTitik(CStr(fJmlBayar)) & "," & msubKonversiKomaTitik(CStr(fJmlPembebasan)) & "," & msubKonversiKomaTitik(CStr(fSisaHutangPenjamin)) & ",1,'" & fStatusPiutang & "')"
        Call msubRecFO(fRS2, fQuery2)
    Else
        ...
        Set fRS2 = Nothing
        fQuery2 = "insert into PembayaranClaimPenjaminPasien values('" & fNoBKM & "','" & fNoStruk & "'," & fJmlBayarSebelumnya & "," & fJmlSudahDibayar & " + " & msubKonversiKomaTitik(CStr(fJmlBayar)) & "," & fJmlPembebasanSebelumnya & " + " & fJmlPembebasan & "," & msubKonversiKomaTitik(CStr(fSisaHutangPenjamin)) & "," & fPembayaranKe & ",'" & fStatusPiutang & "')"
        Call msubRecFO(fRS2, fQuery2)
    End If
    ...
    If UCase(fStatusPiutang) = "SA" Then
        If fTotalSisaHutangPenjaminTM <> 0 Then
            ...
            If sp_AddRekapKomponenBiayaPelayananTMClaimNew(fNoBKM, fNoBKMSebelumnya, fNoStruk, fJmlBayarTM, fJmlPembebasan, fNoPosting) = False Then Exit Function
            If sp_AddRekapKomponenBPRemunerasiTM(fPendaftaran, fNoBKM, fNoStruk, fNoPosting) = False Then Exit Function
        End If
        ...
        If fTotalSisaHutangPenjaminOA <> 0 Then
            ...
            If sp_AddRekapKomponenBiayaPelayananOAClaimNew(fNoBKM, fNoBKMSebelumnya, fNoStruk, fJmlBayarOA, fJmlPembebasan, fNoPosting) = False Then Exit Function
            If sp_AddRekapKomponenBPRemunerasiOA(fPendaftaran, fNoBKM, fNoStruk, fNoPosting) = False Then Exit Function
        End If
    End If
    ...
    If fTotalSisaHutangPenjaminApotik <> 0 And UCase(fStatusPiutang) = "AP" Then
        fJmlBayarApotik = CDec(fJmlBayar)
        fJmlPembebasanApotik = fJmlPembebasan
        fSisaHutangPenjaminApotik = fSisaHutangPenjamin
        If sp_AddRekapKomponenBiayaPelayananApotikClaimNew(fNoBKM, fNoBKMSebelumnya, fNoStruk, fJmlBayarApotik, fJmlPembebasan, fNoPosting) = False Then Exit Function
        If sp_AddRekapKomponenBPRemunerasiApotikNew(fNoBKM, fNoStruk, fNoPosting) = False Then Exit Function
    End If
End Function

Public Function f_AddPembayaranTagihanHutangPenjaminClaimNew(fPendaftaran As String, fNoBKM As String, fNoBKMSebelumnya As String, fNoStruk As String, fJmlBayar As Currency, fJmlPembebasan As Currency, fSisaHutangPenjamin As Currency, fStatusPiutang As String, fNoPosting As String)
    'fStatusPiutang: TM=Tindakan Medis; OA=Obat Alkes; AP=Penjualan Apotik; SA=TM & OA
    Dim fMinPembayaranKe As Integer
    Dim fTempPembayaranKe As Integer
    Dim fPembayaranKe As Integer
    ...
    Dim fJmlBayarSebelumnya As Currency
    Dim fNoBKMClaimSebelumnya As String
    Dim fNoBKMClaimSebelumnya1 As String
    Dim fJmlPembebasanSebelumnya As Currency
    Dim fJmlSudahDibayar As Currency
    Dim fJmlBayarTM As Currency
    Dim fJmlPembebasanTM As Currency
    ...
    If fRS.EOF = True Then
        ...
        Set fRS2 = Nothing
        fQuery2 = "select SisaHutangPenjamin from TotalBiayaPelayananTM where NoStruk='" & fNoStruk & "'"
        Call msubRecFO(fRS2, fQuery2)
        If fRS2.EOF = False Then fTotalSisaHutangPenjaminTM = IIf(IsNull(fRS2("SisaHutangPenjamin").Value), 0, fRS2("SisaHutangPenjamin").Value) Else fTotalSisaHutangPenjaminTM = 0
        Set fRS2 = Nothing
        fQuery2 = "select SisaHutangPenjamin from TotalBiayaPelayananOA where NoStruk='" & fNoStruk & "'"
        Call msubRecFO(fRS2, fQuery2)
        If fRS2.EOF = False Then fTotalSisaHutangPenjaminOA = IIf(IsNull(fRS2("SisaHutangPenjamin").Value), 0, fRS2("SisaHutangPenjamin").Value) Else fTotalSisaHutangPenjaminOA = 0
        Set fRS2 = Nothing
        fQuery2 = "select sum(SisaHutangPenjamin) as JmlHutangPenjamin from PembayaranTagihanPasien where NoStruk='" & fNoStruk & "'"
        Call msubRecFO(fRS2, fQuery2)
        If fRS2.EOF = False Then fTotalSisaHutangPenjaminApotik = IIf(IsNull(fRS2("JmlHutangPenjamin").Value), 0, fRS2("JmlHutangPenjamin").Value) Else fTotalSisaHutangPenjaminApotik = 0
        fSisaHutangPenjaminSebelumnya = fTotalSisaHutangPenjaminTM + fTotalSisaHutangPenjaminOA
        Set fRS2 = Nothing
        ...
        If UCase(fStatusPiutang) = "SA" Then
            If fTotalSisaHutangPenjaminTM <> 0 Then
                fJmlBayarTM = (CDec(fTotalSisaHutangPenjaminTM) / CDec(fSisaHutangPenjaminSebelumnya)) * CDec(fJmlBayar)
                fJmlPembebasanTM = (CDec(fTotalSisaHutangPenjaminTM) / CDec(fSisaHutangPenjaminSebelumnya)) * CDec(fJmlPembebasan)
                fJmlPembebasanTM = (CDbl(fJmlPembebasanTM))
                fSisaHutangPenjaminTM = (CDec(fTotalSisaHutangPenjaminTM) / CDec(fSisaHutangPenjaminSebelumnya)) * CDec(fSisaHutangPenjamin)

                If sp_AddRekapKomponenBiayaPelayananTMClaimNew(fNoBKM, fNoBKMSebelumnya, fNoStruk, FormatCurrency(fJmlBayarTM, 0), fJmlPembebasan, fNoPosting) = False Then Exit Function
                If sp_AddRekapKomponenBPRemunerasiTM(fPendaftaran, fNoBKM, fNoStruk, fNoPosting) = False Then Exit Function
            End If
            ...
            If fTotalSisaHutangPenjaminOA <> 0 Then
                fJmlBayarOA = (CDec(fTotalSisaHutangPenjaminOA) / CDec(fSisaHutangPenjaminSebelumnya)) * CDec(fJmlBayar)
                fJmlPembebasanOA = (CDec(fTotalSisaHutangPenjaminOA) / CDec(fSisaHutangPenjaminSebelumnya)) * CDec(fJmlPembebasan)
                fJmlPembebasanOA = (CDbl(fJmlPembebasanOA))
                fSisaHutangPenjaminOA = (CDec(fTotalSisaHutangPenjaminOA) / CDec(fSisaHutangPenjaminSebelumnya)) * CDec(fSisaHutangPenjamin)
                If sp_AddRekapKomponenBiayaPelayananOAClaimNew(fNoBKM, fNoBKMSebelumnya, fNoStruk, FormatCurrency(fJmlBayarOA, 0), fJmlPembebasan, fNoPosting) = False Then Exit Function
                If sp_AddRekapKomponenBPRemunerasiOA(fPendaftaran, fNoBKM, fNoStruk, fNoPosting) = False Then Exit Function
            End If
        End If
        ...
        If fTotalSisaHutangPenjaminApotik <> 0 And UCase(fStatusPiutang) = "AP" Then
            ...
            fJmlPembebasanApotik = fJmlPembebasan
            fSisaHutangPenjaminApotik = fSisaHutangPenjamin
            If sp_AddRekapKomponenBiayaPelayananApotikClaimNew(fNoBKM, fNoBKMSebelumnya, fNoStruk, FormatCurrency(fJmlBayarApotik, 0), fJmlPembebasan, fNoPosting) = False Then Exit Function
            If sp_AddRekapKomponenBPRemunerasiApotikNew(fNoBKM, fNoStruk, fNoPosting) = False Then Exit Function
        End If
    Else
        ...
        Else
            fPembayaranKe = fTempPembayaranKe + 1
            fMaksPembayaranKe = fPembayaranKe
        End If

        Set fRS2 = Nothing
        fQuery2 = "select NoBKM,SisaHutangPenjamin from PembayaranTagihanPasien where NoStruk='" & fNoStruk & "'"
        Call msubRecFO(fRS2, fQuery2)

        If fRS2.EOF = False Then fNoBKMClaimSebelumnya1 = IIf(IsNull(fRS2("NoBKM").Value), "", fRS2("NoBKM").Value) Else fNoBKMClaimSebelumnya = ""
        If fRS2.EOF = False Then fSisaHutangPenjaminSebelumnya = IIf(IsNull(fRS2("SisaHutangPenjamin").Value), 0, fRS2("SisaHutangPenjamin").Value) Else fSisaHutangPenjaminSebelumnya = 0

        Set fRS2 = Nothing
        fQuery2 = "select NoBKM,JmlSudahDibayar,JmlPembebasan from PembayaranClaimPenjaminPasien where NoStruk='" & fNoStruk & "' and PembayaranKe='" & fTempPembayaranKe & "' "
        Call msubRecFO(fRS2, fQuery2)
        ...
        Set fRS2 = Nothing
        fQuery2 = "select SisaHutangPenjamin from PembayaranTagihanPasien where NoStruk='" & fNoStruk & "'"
        Call msubRecFO(fRS2, fQuery2)
        If fRS2.EOF = False Then fTotalSisaHutangPenjaminApotik = IIf(IsNull(fRS2("SisaHutangPenjamin").Value), 0, fRS2("SisaHutangPenjamin").Value) Else fTotalSisaHutangPenjaminApotik = 0
        Set fRS2 = Nothing

        fQuery2 = "insert into PembayaranClaimPenjaminPasien values('" & fNoBKM & "','" & fNoStruk & "'," & msubKonversiKomaTitik(CStr(fJmlBayarSebelumnya)) & ", " & msubKonversiKomaTitik(CStr(fJmlBayar)) & "," & msubKonversiKomaTitik(CStr(fJmlPembebasan)) & "," & msubKonversiKomaTitik(CStr(fSisaHutangPenjamin)) & "," & fPembayaranKe & ",'" & fStatusPiutang & "')"
        Call msubRecFO(fRS2, fQuery2)

        If UCase(fStatusPiutang) = "SA" Then
            If fTotalSisaHutangPenjaminTM <> 0 Then
                If fSisaHutangPenjaminSebelumnya > 0 Then
                    fJmlBayarTM = (CDec(fTotalSisaHutangPenjaminTM) / CDec(fSisaHutangPenjaminSebelumnya)) * CDec(fJmlBayar)
                Else
                    fJmlBayarTM = 0
                End If
                ...
                If fSisaHutangPenjaminSebelumnya > 0 Then
                    fSisaHutangPenjaminTM = (CDec(fTotalSisaHutangPenjaminTM) / CDec(fSisaHutangPenjaminSebelumnya)) * CDec(fSisaHutangPenjamin)
                Else
                    fSisaHutangPenjaminTM = 0
                End If

                If sp_AddRekapKomponenBiayaPelayananTMClaimNew(fNoBKM, fNoBKMClaimSebelumnya1, fNoStruk, FormatCurrency(fJmlBayarTM, 0), fJmlPembebasan, fNoPosting) = False Then Exit Function
                If sp_AddRekapKomponenBPRemunerasiTM(fPendaftaran, fNoBKM, fNoStruk, fNoPosting) = False Then Exit Function
            End If
            If fTotalSisaHutangPenjaminOA <> 0 Then
                If fSisaHutangPenjaminSebelumnya > 0 Then
                ...
                If fSisaHutangPenjaminSebelumnya > 0 Then
                    fSisaHutangPenjaminOA = (CDec(fTotalSisaHutangPenjaminOA) / CDec(fSisaHutangPenjaminSebelumnya)) * CDec(fSisaHutangPenjamin)
                Else
                    fSisaHutangPenjaminOA = 0
                End If
                If sp_AddRekapKomponenBiayaPelayananOAClaimNew(fNoBKM, fNoBKMClaimSebelumnya1, fNoStruk, FormatCurrency(fJmlBayarOA, 0), fJmlPembebasan, fNoPosting) = False Then Exit Function
                If sp_AddRekapKomponenBPRemunerasiOA(fPendaftaran, fNoBKM, fNoStruk, fNoPosting) = False Then Exit Function
            End If
        End If
        If fTotalSisaHutangPenjaminTM <> 0 And UCase(fStatusPiutang) = "TM" Then
        ...
        If fTotalSisaHutangPenjaminApotik <> 0 And UCase(fStatusPiutang) = "AP" Then
            ...
            Else
                fSisaHutangPenjaminApotik = 0
            End If
            If sp_AddRekapKomponenBiayaPelayananApotikClaimNew(fNoBKM, fNoBKMClaimSebelumnya1, fNoStruk, FormatCurrency(fJmlBayarApotik, 0), fJmlPembebasan, fNoPosting) = False Then Exit Function
            If sp_AddRekapKomponenBPRemunerasiApotikNew(fNoBKM, fNoStruk, fNoPosting) = False Then Exit Function
        End If
...
Public Function f_AddPembayaranTagihanPasienApotikKredit(fNoBKM As String, fNoStruk As String, fJmlBayar As Currency, fJmlPembebasan As Currency, fSisaTagihan As Currency)
    ...
    Set fRS = Nothing
    fQuery = "select JmlHutangPenjamin from strukPelayananPasien where NoStruk = '" & fNoStruk & "'"
    Call msubRecFO(fRS, fQuery)
    If IsNull(fRS("JmlHutangPenjamin").Value) = True Then HutangPenjamin = 0 Else HutangPenjamin = fRS("JmlHutangPenjamin").Value

    Set fRS = Nothing
    fQuery = "insert into PembayaranTagihanPasien values('" & fNoBKM & "','" & fNoStruk & "'," & fJmlBayarSebelumnya & "," & fJmlSudahDibayar & " + " & fJmlBayar & "," & fJmlPembebasan & "," & fSisaTagihan & "," & fPembayaranKe & ",'" & fStatusPiutang & "'," & msubKonversiKomaTitik(CStr(HutangPenjamin)) & ")"
    Call msubRecFO(fRS, fQuery)
...
Public Function f_AddPembayaranTagihanPasienKredit(fNoBKM As String, fNoStruk As String, fJmlBayar As Currency, fJmlPembebasan As Currency, fSisaTagihan As Currency, fNoPosting As String)
    ...
    If fStatusPiutang = "SA" Then
        ...
        ''error bayar keredit, gak masuk komponenlaporan
        ...
        Call msubRecFO(fRS, fQuery)
        '        Call f_AddRekapKomponenBiayaPelayananTMKredit(fNoBKM, fNoBKMSebelumnya, fNoStruk, fJmlBayarTM, fJmlPembebasanTM, fSisaTagihanTM)
        '        Call f_AddRekapKomponenBiayaPelayananOAKredit(fNoBKM, fNoBKMSebelumnya, fNoStruk, fJmlBayarOA, fJmlPembebasanOA, fSisaTagihanOA)
        '2008-06-03
        ...
        Call msubRecFO(fRS, fQuery)
        Call Add_HistoryLoginActivity("Add_PostingDataOtomatis+Add_RekapKomponenBiayaPelayananTMKreditNew+Add_RekapKomponenBiayaPelayananOAKreditNew+Add_RekapKomponenBPRemunerasiTMNew+Add_RekapKomponenBPRemunerasiOANew")
    End If
    If fStatusPiutang = "TM" Then
        ...
        fQuery = " update TotalBiayaPelayananTMHistory set JmlSudahDibayar=" & msubKonversiKomaTitik(CStr(fJmlBayarTM)) & " + " & msubKonversiKomaTitik(CStr(fTotalJmlSudahDibayarTM)) & ",JmlPembebasan=" & msubKonversiKomaTitik(CStr(fJmlPembebasanTM)) & " + " & msubKonversiKomaTitik(CStr(fTotalJmlPembebasanTM)) & ",SisaTagihan=" & msubKonversiKomaTitik(CStr(fSisaTagihanTM)) & " where NoStruk='" & fNoStruk & "'"
        Call msubRecFO(fRS, fQuery)
        Call Add_HistoryLoginActivity("Add_PostingDataOtomatis+Add_RekapKomponenBiayaPelayananTMKreditNew+Add_RekapKomponenBPRemunerasiTMNew")
    End If
    If fStatusPiutang = "OA" Then
        ...
        fQuery = "update TotalBiayaPelayananOAHistory set JmlSudahDibayar=" & msubKonversiKomaTitik(CStr(fJmlBayarOA)) & " + " & msubKonversiKomaTitik(CStr(fTotalJmlSudahDibayarOA)) & ",JmlPembebasan=" & msubKonversiKomaTitik(CStr(fJmlPembebasanOA)) & " + " & msubKonversiKomaTitik(CStr(fTotalJmlPembebasanOA)) & ",SisaTagihan=" & msubKonversiKomaTitik(CStr(fSisaTagihanOA)) & " where NoStruk='" & fNoStruk & "'"
        Call msubRecFO(fRS, fQuery)
        Call Add_HistoryLoginActivity("Add_PostingDataOtomatis+Add_RekapKomponenBiayaPelayananOAKreditNew+Add_RekapKomponenBPRemunerasiOANew")
    End If
End Function
...
Public Function f_AddPembayaranTagihanHutangPenjaminClaimNew_PerPelayanan(fPendaftaran As String, fNoBKM As String, fNoBKMSebelumnya As String, fNoStruk As String, fJmlBayar As Currency, fJmlPembebasan As Currency, fSisaHutangPenjamin As Currency, fStatusPiutang As String, fNoPosting As String, fKdPelRS As String, fNopen As String, fKdRuangan As String, fTgl As Date, fKdAsal As String, fSatuan As String)
    ...
    If fTotalSisaHutangPenjaminTM <> 0 And UCase(fStatusPiutang) = "TM" Then
        ...
        Else
            fSisaHutangPenjaminTM = 0
        End If
        If sp_AddRekapKomponenBiayaPelayananTMClaimNewPerPelayanan(fNoBKM, fNoBKMClaimSebelumnya1, fNoStruk, CCur(fJmlBayarTM), fNoPosting, fKdPelRS, fNopen, fKdRuangan, fTgl, fTotalSisaHutangPenjaminTM, fJmlPembebasanTM) = False Then Exit Function
    End If
    If fTotalSisaHutangPenjaminOA <> 0 And UCase(fStatusPiutang) = "OA" Then
        If fSisaHutangPenjaminSebelumnya > 0 Then
            fJmlBayarOA = (CDec(fTotalSisaHutangPenjaminOA) / CDec(fSisaHutangPenjaminSebelumnya)) * CDec(fJmlBayar)
        ...
        If sp_AddRekapKomponenBiayaPelayananOAClaimNewPerPelayanan(fNoBKM, fNoBKMClaimSebelumnya1, fNoStruk, CCur(fJmlBayarOA), fNoPosting, fKdPelRS, fNopen, fKdRuangan, fTgl, fTotalSisaHutangPenjaminOA, fJmlPembebasanOA) = False Then Exit Function
    End If
    If fTotalSisaHutangPenjaminApotik <> 0 And UCase(fStatusPiutang) = "AP" Then
        If fSisaHutangPenjaminSebelumnya > 0 Then
            fJmlBayarApotik = (CDec(fTotalSisaHutangPenjaminApotik) / CDec(fSisaHutangPenjaminSebelumnya)) * CDec(fJmlBayar)
        ...
        If sp_AddRekapKomponenBiayaPelayananApotikClaimNewPerPelayanan(fNoBKM, fNoBKMClaimSebelumnya1, fNoStruk, CCur(fJmlBayarApotik), fNoPosting, fKdRuangan, fKdPelRS, fKdAsal, fSatuan, fTotalSisaHutangPenjaminApotik, fJmlPembebasanApotik) = False Then Exit Function
    End If
End Function

Public Function sp_AddRekapKomponenBiayaPelayananTMClaimNewPerPelayanan(fNoBKM, fNoBKMClaimSebelumnya, fNoStruk, fJmlBayarTM, fNoPosting, fKdPelayanan, fPendaftaran, fKdRuangan, fTglPelayanan, fTotalHutangPenjamin, fPembebasan) As Boolean
    On Error GoTo hell_
    sp_AddRekapKomponenBiayaPelayananTMClaimNewPerPelayanan = True
    Set dbcmd = New ADODB.Command
    With dbcmd
        .Parameters.Append .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, , Null)
        .Parameters.Append .CreateParameter("NoBKM", adChar, adParamInput, 10, fNoBKM)
        ...
        .Parameters.Append .CreateParameter("JmlBayar", adCurrency, adParamInput, , fJmlBayarTM)
        .Parameters.Append .CreateParameter("NoPosting", adChar, adParamInput, 10, fNoPosting)
        .Parameters.Append .CreateParameter("KdPelayananRS", adChar, adParamInput, 6, fKdPelayanan)
        .Parameters.Append .CreateParameter("NoPendaftaran", adChar, adParamInput, 10, fPendaftaran)
        .Parameters.Append .CreateParameter("KdRuangan", adChar, adParamInput, 3, fKdRuangan)
        .Parameters.Append .CreateParameter("TglPelayanan", adDate, adParamInput, , Format(fTglPelayanan, "yyyy/mm/dd HH:mm:ss"))
        .Parameters.Append .CreateParameter("TotalHutangPenjamin", adCurrency, adParamInput, , fTotalHutangPenjamin)
        .Parameters.Append .CreateParameter("TotalPembebasan", adCurrency, adParamInput, , fPembebasan)

        .ActiveConnection = dbConn
        .CommandText = "dbo.Add_RekapKomponenBiayaPelayananTMClaimNew_PerPelayanan"
        .CommandType = adCmdStoredProc
        .Execute

        If .Parameters("RETURN_VALUE").Value <> 0 Then
            MsgBox "Ada Kesalahan dalam Penyimpanan Rekap Komponen Biaya Pelayanan", vbCritical, "Validasi"
            sp_AddRekapKomponenBiayaPelayananTMClaimNewPerPelayanan = False
        End If
        Call deleteADOCommandParameters(dbcmd)
        Set dbcmd = Nothing
    End With
...
hell_:
    sp_AddRekapKomponenBiayaPelayananTMClaimNewPerPelayanan = False
    Call msubPesanError("-Add_RekapKomponenBiayaPelayananTMClaimNew_PerPelayanan")
End Function

Public Function sp_AddRekapKomponenBiayaPelayananOAClaimNewPerPelayanan(fNoBKM, fNoBKMClaimSebelumnya, fNoStruk, fJmlBayarTM, fNoPosting, fKdBarang, fPendaftaran, fKdRuangan, fTglPelayanan, fTotalHutangPenjamin, fPembebasan) As Boolean
    On Error GoTo hell_
    sp_AddRekapKomponenBiayaPelayananOAClaimNewPerPelayanan = True
    Set dbcmd = New ADODB.Command
    With dbcmd
        .Parameters.Append .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, , Null)
        .Parameters.Append .CreateParameter("NoBKM", adChar, adParamInput, 10, fNoBKM)
        ...
        .Parameters.Append .CreateParameter("JmlBayar", adCurrency, adParamInput, , fJmlBayarTM)
        .Parameters.Append .CreateParameter("NoPosting", adChar, adParamInput, 10, fNoPosting)
        .Parameters.Append .CreateParameter("KdBarang", adVarChar, adParamInput, 9, fKdBarang)
        .Parameters.Append .CreateParameter("NoPendaftaran", adChar, adParamInput, 10, fPendaftaran)
        .Parameters.Append .CreateParameter("KdRuangan", adChar, adParamInput, 3, fKdRuangan)
        .Parameters.Append .CreateParameter("TglPelayanan", adDate, adParamInput, , Format(fTglPelayanan, "yyyy/mm/dd HH:mm:ss"))
        .Parameters.Append .CreateParameter("TotalHutangPenjamin", adCurrency, adParamInput, , fTotalHutangPenjamin)
        ...
        .ActiveConnection = dbConn
        .CommandText = "dbo.Add_RekapKomponenBiayaPelayananOAClaimNew_PerPelayanan"
        .CommandType = adCmdStoredProc
        .Execute

        If .Parameters("RETURN_VALUE").Value <> 0 Then
            MsgBox "Ada Kesalahan dalam Penyimpanan Rekap Komponen Biaya Pelayanan", vbCritical, "Validasi"
            sp_AddRekapKomponenBiayaPelayananOAClaimNewPerPelayanan = False
        End If
        Call deleteADOCommandParameters(dbcmd)
        Set dbcmd = Nothing
    End With
...
hell_:
    sp_AddRekapKomponenBiayaPelayananOAClaimNewPerPelayanan = False
    Call msubPesanError("-Add_RekapKomponenBiayaPelayananOAClaimNew_PerPelayanan")
End Function

Public Function sp_AddRekapKomponenBiayaPelayananApotikClaimNewPerPelayanan(fNoBKM, fNoBKMClaimSebelumnya, fNoStruk, fJmlBayarApotik, fNoPosting, fKdRuangan, fKdBarang, fKdAsal, fSatuan, fTotalHutangPenjamin, fPembebasan) As Boolean
    On Error GoTo hell_
    sp_AddRekapKomponenBiayaPelayananApotikClaimNewPerPelayanan = True
    Set dbcmd = New ADODB.Command
    With dbcmd
        .Parameters.Append .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, , Null)
        .Parameters.Append .CreateParameter("NoBKM", adChar, adParamInput, 10, fNoBKM)
        ...
        .Parameters.Append .CreateParameter("NoPosting", adChar, adParamInput, 10, fNoPosting)
        .Parameters.Append .CreateParameter("KdRuangan", adChar, adParamInput, 3, fKdRuangan)
        .Parameters.Append .CreateParameter("KdBarang", adChar, adParamInput, 9, fKdBarang)
        .Parameters.Append .CreateParameter("KdAsal", adChar, adParamInput, 2, fKdAsal)
        .Parameters.Append .CreateParameter("SatuanJml", adChar, adParamInput, 1, "S")
        .Parameters.Append .CreateParameter("TotalHutangPenjamin", adCurrency, adParamInput, , fTotalHutangPenjamin)
        .Parameters.Append .CreateParameter("TotalPembebasan", adCurrency, adParamInput, , fPembebasan)

        .ActiveConnection = dbConn
        .CommandText = "dbo.Add_RekapKomponenBiayaPelayananApotikClaimNew_PerPelayanan"
        .CommandType = adCmdStoredProc
        .Execute

        If .Parameters("RETURN_VALUE").Value <> 0 Then
            MsgBox "Ada Kesalahan dalam Penyimpanan Rekap Komponen Biaya Pelayanan", vbCritical, "Validasi"
            sp_AddRekapKomponenBiayaPelayananApotikClaimNewPerPelayanan = False
        End If
        Call deleteADOCommandParameters(dbcmd)
        Set dbcmd = Nothing
    End With
...
hell_:
    sp_AddRekapKomponenBiayaPelayananApotikClaimNewPerPelayanan = False
    Call msubPesanError("-Add_RekapKomponenBiayaPelayananApotikClaimNew_PerPelayanan")
End Function

Public Function sp_AddRekapKomponenBiayaPelayananTMClaimTRSNew(fNoBKM, fNoBKMClaimSebelumnya, fNoStruk, fJmlBayarTM, fJmlPembebasan, fNoPosting) As Boolean
    On Error GoTo hell_
    sp_AddRekapKomponenBiayaPelayananTMClaimTRSNew = True
    Set dbcmd = New ADODB.Command
    With dbcmd
        .Parameters.Append .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, , Null)
        .Parameters.Append .CreateParameter("NoBKM", adChar, adParamInput, 10, fNoBKM)
        ...
        .ActiveConnection = dbConn
        .CommandText = "dbo.Add_RekapKomponenBiayaPelayananTMClaimTRSNew"
        .CommandType = adCmdStoredProc
        .Execute

        If .Parameters("RETURN_VALUE").Value <> 0 Then
            MsgBox "Ada Kesalahan dalam Penyimpanan Rekap Komponen Biaya Pelayanan", vbCritical, "Validasi"
            sp_AddRekapKomponenBiayaPelayananTMClaimTRSNew = False
        End If
        Call deleteADOCommandParameters(dbcmd)
        Set dbcmd = Nothing
    End With
...
hell_:
    sp_AddRekapKomponenBiayaPelayananTMClaimTRSNew = False
    Call msubPesanError("-Add_RekapKomponenBiayaPelayananTMClaimTRSNew")
End Function

'20091111 Add By CursedKnight for Pembayaran For Claim TRS
Public Function sp_AddRekapKomponenBiayaPelayananOAClaimTRSNew(fNoBKM, fNoBKMClaimSebelumnya, fNoStruk, fJmlBayarOA, fJmlPembebasan, fNoPosting) As Boolean
    On Error GoTo hell_
    sp_AddRekapKomponenBiayaPelayananOAClaimTRSNew = True
    Set dbcmd = New ADODB.Command
    With dbcmd
        .Parameters.Append .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, , Null)
        .Parameters.Append .CreateParameter("NoBKM", adChar, adParamInput, 10, fNoBKM)
        ...
        .ActiveConnection = dbConn
        .CommandText = "dbo.Add_RekapKomponenBiayaPelayananOAClaimTRSNew"
        .CommandType = adCmdStoredProc
        .Execute

        If .Parameters("RETURN_VALUE").Value <> 0 Then
            MsgBox "Ada Kesalahan dalam Penyimpanan Rekap Komponen Biaya Pelayanan", vbCritical, "Validasi"
            sp_AddRekapKomponenBiayaPelayananOAClaimTRSNew = False
        End If
        Call deleteADOCommandParameters(dbcmd)
        Set dbcmd = Nothing
    End With
...
hell_:
    sp_AddRekapKomponenBiayaPelayananOAClaimTRSNew = False
    Call msubPesanError("-sp_AddRekapKomponenBiayaPelayananOAClaimTRSNew")
End Function

'20091111 Add By CursedKnight for Pembayaran For Claim TRS
Public Function sp_AddRekapKomponenBiayaPelayananApotikClaimTRSNew(fNoBKM, fNoBKMClaimSebelumnya, fNoStruk, fJmlBayarApotik, fJmlPembebasan, fNoPosting) As Boolean
    On Error GoTo hell_
    sp_AddRekapKomponenBiayaPelayananApotikClaimTRSNew = True
    Set dbcmd = New ADODB.Command
    With dbcmd
        .Parameters.Append .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue, , Null)
        .Parameters.Append .CreateParameter("NoBKM", adChar, adParamInput, 10, fNoBKM)
        ...
        .ActiveConnection = dbConn
        .CommandText = "dbo.Add_RekapKomponenBiayaPelayananApotikClaimTRSNew"
        .CommandType = adCmdStoredProc
        .Execute

        If .Parameters("RETURN_VALUE").Value <> 0 Then
            MsgBox "Ada Kesalahan dalam Penyimpanan Rekap Komponen Biaya Pelayanan", vbCritical, "Validasi"
            sp_AddRekapKomponenBiayaPelayananApotikClaimTRSNew = False
        End If
        Call deleteADOCommandParameters(dbcmd)
        Set dbcmd = Nothing
    End With
...
hell_:
    sp_AddRekapKomponenBiayaPelayananApotikClaimTRSNew = False
    Call msubPesanError("-sp_AddRekapKomponenBiayaPelayananApotikClaimTRSNew")
End Function
