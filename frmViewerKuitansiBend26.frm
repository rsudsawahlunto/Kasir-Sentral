...
Begin VB.Form frmViewerKuitansiBend26 
   Caption         =   "Kuitansi Model : Bend 26"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   Icon            =   "frmViewerKuitansiBend26.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   3195
   ScaleWidth      =   4680
   ...
   End
End
Attribute VB_Name = "frmViewerKuitansiBend26"
...
Private Sub subDataReport(s_NamaReport As CRAXDRT.Report, Optional s_Versi As Integer)
    ...
    With Report
        ...
        .txtTglTerima.SetText varTglBKMCek
        .txtTglBayar.SetText Format(varTglBKMCek, "dd mmmm yyyy hh:MM:ss")
...
Private Sub Form_Unload(Cancel As Integer)
    Set frmViewerKuitansiBend26 = Nothing
End Sub
