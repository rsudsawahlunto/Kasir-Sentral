...
Begin VB.Form frmUbahJenisPasien2 
   ...
   EndProperty
   Icon            =   "frmUbahJenisPasien2.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image2 
      Height          =   945
      Left            =   8880
      Picture         =   "frmUbahJenisPasien2.frx":0CCA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1875
   End
   Begin VB.Image Image3 
      Height          =   975
      Left            =   0
      Picture         =   "frmUbahJenisPasien2.frx":1A52
      Stretch         =   -1  'True
      Top             =   0
      Width           =   1800
   End
   Begin VB.Image Image1 
      Height          =   975
      Left            =   1800
      Picture         =   "frmUbahJenisPasien2.frx":4413
      Stretch         =   -1  'True
      Top             =   0
      Width           =   13095
   End
End
Attribute VB_Name = "frmUbahJenisPasien2"
...
Private Sub cmdTutup_Click()
    If mblnTemp = True Then
        Unload Me
        frmDaftarPasienAktif.Enabled = True
        mblnTemp = False
    Else
        Unload Me
        frmDaftarPasienAktif.Enabled = True
...
Private Sub dcDiagnosa_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        If dcDiagnosa.MatchedWithList = True Then
